          ...
          <div className="space-y-4 md:col-span-1">
            <Link href="/" className="flex items-center space-x-2.5">
              ...
              <span className="font-bold text-lg tracking-tight text-foreground">
                Aswal <span className="text-emerald-500">Web Studio</span>
              </span>
            </Link>
            ...
            <div className="flex flex-col space-y-2.5 pt-2 text-xs text-foreground/80 font-medium">
              <a href="tel:+917304610459" className="flex items-center hover:text-emerald-500 transition-colors">
                <Phone className="h-4 w-4 mr-2 text-emerald-500" />
                +91 7304610459
              </a>
              <a href="mailto:aman9lion@gmail.com" className="flex items-center hover:text-emerald-500 transition-colors">
                <Mail className="h-4 w-4 mr-2 text-emerald-500" />
                aman9lion@gmail.com
              </a>
              <a href="https://wa.me/917304610459?text=Hi!%20I'm%20interested%20in%20a%20website%20quote%20from%20Aswal%20Web%20Studio." target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-emerald-500 transition-colors text-emerald-500 font-semibold">
              ...
              <a href="https://www.instagram.com/aswalwebstudio/" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-emerald-500 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4 mr-2 text-emerald-500">
