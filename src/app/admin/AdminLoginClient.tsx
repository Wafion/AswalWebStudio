        ...
        <div className="bg-card border border-card-border p-8 rounded-3xl shadow-2xl space-y-6">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full inline-flex items-center justify-center py-3 px-4 bg-emerald-500 hover:bg-emerald-600 text-white font-bold rounded-xl transition-all shadow-md shadow-emerald-500/15 disabled:opacity-50 cursor-pointer"
            >
